...
for (;markPoint <= finish;) {
  k +=1;
  markPoint +=4;
} 
console.log ('Количество високосных лет, начиная с 1800, и по 2020 годы : ', k);


const startPeriod = 1800;
const endPeriod = 2020;
let i = 0;
let marker = startPeriod;
for (;marker <= endPeriod;) {
  
  if (marker === 1961) {
    console.log ('В 1961-м году осуществлён первый полёт в космос');  
    break;
  };
